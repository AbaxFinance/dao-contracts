...
async function changeBaseCreatedAmounts(this: Chai.AssertionPrototype, contract: any, addresses: string[], deltas: BN[]): Promise<void> {
  //
...
const CHANGE_BASE_CREATED_AMOUNTS = 'changeBaseCreatedAmounts';

export function supportChangeBaseCreatedAmounts(Assertion: Chai.AssertionStatic, chaiUtils: Chai.ChaiUtils) {
  Assertion.addMethod(CHANGE_BASE_CREATED_AMOUNTS, function (this: Chai.AssertionPrototype, contract: any, addresses: string[], deltas: BN[]) {
    ...
    const derivedPromise = changeBaseCreatedAmounts.apply(this, [contract, addresses, deltas]);
